...
// your spreadsheet id
const _spreadsheetId = '1DPLK6Nyfx8VKtOF4bjEr1z9d_Ek3gMvnZwbGmLQkKyE';
...
Future<dynamic> getSheet(BuildContext context) async {
  ...
  return await getTeach(sheet, context);
}

Future<Widget> getTeach(Worksheet sheet, BuildContext context) async {
  List<Widget> lisoft = [];
  //lisoft.add();
  int i;
...
class StudView extends StatelessWidget {
